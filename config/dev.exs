...
config :ddbm, Ddbm.Repo,
  database: Path.expand("../ddbm.db", __DIR__),
  pool_size: 5,
  stacktrace: true,
...
config :ddbm_web, DdbmWeb.Endpoint,
  ...
  watchers: [
    ...
    esbuild: {Esbuild, :install_and_run, [:ddbm_web, ~w(--watch)]}
  ]
...
config :ddbm_web, dev_routes: true
...
# Discord bot - provide DISCORD_TOKEN env var to enable
